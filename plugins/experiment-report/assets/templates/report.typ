...
// Pandoc template integration
#show: doc => report(
  title: "$if(title)$$title$$else$Report$endif$",
  author: "$if(author)$$for(author)$$author$$sep$, $endfor$$endif$",
  date: "$if(date)$$date$$endif$",
  abstract: $if(abstract)$"$abstract$"$else$none$endif$,
  doc,
)
